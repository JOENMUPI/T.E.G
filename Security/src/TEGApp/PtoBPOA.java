...
public abstract class PtoBPOA extends org.omg.PortableServer.Servant
 implements TEGApp.PtoBOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public PtoB _this() 
  {
    return PtoBHelper.narrow(
    super._this_object());
  }

  public PtoB _this(org.omg.CORBA.ORB orb) 
  {
    return PtoBHelper.narrow(
