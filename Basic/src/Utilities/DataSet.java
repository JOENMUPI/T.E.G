...
public class DataSet implements Serializable{
	...
	public boolean hasNext() { 
		if (this.current < this.row.length) { return true; 
		} else { return false; } 
	}
	public Row first() { this.current = 0; return this.row[this.current]; }
	public Row last() { return this.row[this.row.length-1]; }
	public int getRecordCount() { return this.list.size(); }
	public int getFieldCount() { return this.fieldCount; }
	public Caster getField(String key) { return this.row[this.current].getField(key); }
	public Caster getField(int i) { return this.row[this.current].getField(i); }	
}