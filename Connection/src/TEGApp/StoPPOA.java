...
public abstract class StoPPOA extends org.omg.PortableServer.Servant
 implements TEGApp.StoPOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public StoP _this() 
  {
    return StoPHelper.narrow(
    super._this_object());
  }

  public StoP _this(org.omg.CORBA.ORB orb) 
  {
    return StoPHelper.narrow(
